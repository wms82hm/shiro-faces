...
{
	/**
	 * Creates the TagHandler for the tag that renders the tag body if the current user known to the system, either from
	 * a successful login attempt (not necessarily during the current session) or from 'RememberMe' services.
	 *
	 * @param config
