...
{
	/**
	 * Creates the TagHandler for the tag that renders the tag body only if the current user's identity (aka principals)
	 * is remembered from a successful authentication during a previous session and the user has <b>not</b> executed a
